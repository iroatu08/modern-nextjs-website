...
const InsightCard = ({ imgUrl, title, subtitle, index }) => (
  ...
  >
    <img src={imgUrl} className="md:w-[270px] w-full h-[250px] rounded-[32px] object-cover" alt="planet-01" />

    <div className="w-full flex justify-between items-center">
      <div className="flex-1 md:ml-[62px] flex flex-col max-w-[650px]">
        <h4 className="font-normal lg:text-[42px] text-[22px] text-white">{title}</h4>
